<template>
  <div>
    <!-- <x-header>分配兑换码</x-header> -->
    <div style="text-align:left;font-size:14px;padding:5px;background-color:#f0f0f0">
      {{info}}
    </div>
    <scroller lock-x
              scrollbar-y
      ...
      <div class="box2">
        ...
        <!-- <flexbox v-for="i in n2">
          ...
          <flexbox-item>占位</flexbox-item>
        </flexbox> -->
        <flexbox v-for="(i, index) in n2"
                 :key="index"
                 class="flexboxdemo">
          <flexbox-item :span="2">
            <div class="flex-qcode-img">
              <img style="width:50px;height50px;position: absolute;left:50%;top:50%;margin-top:-25px;margin-left:-25px;"
                   src="../assets/logo.png" />
            </div>
          </flexbox-item>
          <flexbox-item :span="6">
            <div class="flex-qcode-middle">
              <div>周杰伦</div>
              <div>用户数</div>
              <div>收费用户</div>
            </div>
